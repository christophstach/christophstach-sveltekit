...
<div>
	<h2 class="mb-4 border-b-2 border-black text-2xl">Hi my name is Christoph,</h2>

	<p class="prose prose-sm prose-indigo max-w-none mb-2">
	...
	<p class="prose prose-sm prose-indigo max-w-none">
        ...
        Then when coming back to Germany, I moved to Berlin where I started to studying at <a href="https://www.htw-berlin.de/">HTW Berlin</a>, 
